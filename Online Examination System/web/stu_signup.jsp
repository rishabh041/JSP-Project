...
<% String username=request.getParameter("Username");
  ...
  if(rs1.getString("email").equals(email))
  {
      ...
      %>
      <jsp:forward page="stu_signup2.jsp" />
      <%
  }}
   while(rs2.next()){
  ...
  if(rs4.getString("username").equals(username))
  {
      out.println("<center><h3 style='color:red;'>Your email id or phone number is already registered</h3></centre>");
      %>
      <jsp:forward page="stu_signup3.jsp" />
      <%
  }}
        ...
        conn.close();
        out.println("<center><h2>Record Added successfully<br><br></h2></center>");
        out.println("<center><br><a href='stu_signup.html'><button>Add new</button></a></center>");
        out.println("<center><br><a href='adminTasks.jsp'><button>More Queries</button></a></center>");
